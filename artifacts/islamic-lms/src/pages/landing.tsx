        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-20 md:py-28 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
              <Link href="/lead/boys">
                <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-4 rounded-xl shadow-xl transition-all hover:shadow-blue-900/50 hover:scale-105 text-base">
                  <span>👦</span> {t.enrollBoys}
                </button>
              </Link>
              <Link href="/lead/girls">
                <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-pink-600 hover:bg-pink-700 text-white font-bold px-8 py-4 rounded-xl shadow-xl transition-all hover:shadow-pink-900/50 hover:scale-105 text-base">
