...
// WhatsApp numbers — replace with real ones
const WA_BOYS = "https://wa.me/923001234567?text=Boys+Admission+Inquiry";
const WA_GIRLS = "https://wa.me/923001234568?text=Girls+Admission+Inquiry";
const WA_ADMIN = "https://wa.me/923001234567?text=General+Inquiry+AtwsQuranofficial";
...
export default function Landing() {
  ...
  const t = LANGS[lang];
  const isRtl = lang === "ur" || lang === "ar" || lang === "ps";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-white font-bold">AtwsQuranofficial</span>
                <p className="text-xs text-green-500">إشاعة التوحيد والسنة · وحدة المدارس الإسلامية</p>
              </div>
            </div>
            <div className="flex gap-6 text-xs">
              ...
              <Link href="/login"><span className="hover:text-white transition-colors cursor-pointer">Login</span></Link>
            </div>
            <p className="text-xs text-green-600">© 2025 AtwsQuranofficial. Online Islamic Education.</p>
          </div>
        </div>
      </footer>
    </div>
