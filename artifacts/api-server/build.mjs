...
async function buildAll() {
  ...
  // Build 1: Standalone server (for Replit / VPS deployment)
  await esbuild({
  ...
  // Build 2: Netlify Function (wraps Express with serverless-http)
  const netlifyFunctionsDir = path.resolve(artifactDir, "../../netlify/functions");
